...
const cspDirectives = [
    "default-src 'self'",
    "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com https://ssl.google-analytics.com https://pagead2.googlesyndication.com https://cdn.ampproject.org https://adservice.google.com https://tpc.googlesyndication.com",
    "script-src-elem 'self' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com https://ssl.google-analytics.com https://pagead2.googlesyndication.com https://cdn.ampproject.org https://adservice.google.com https://tpc.googlesyndication.com",
    ...
    `connect-src 'self' http://127.0.0.1:8000 http://localhost:8000 https://${siteHostname} https://www.${siteHostname} https://imagedelivery.net https://*.replit.dev https://*.riker.replit.dev https://www.google-analytics.com https://analytics.google.com https://stats.g.doubleclick.net https://www.googletagmanager.com https://region1.google-analytics.com https://pagead2.googlesyndication.com https://adservice.google.com https://googleads.g.doubleclick.net`,
    "font-src 'self' data:",
    "object-src 'none'",
    "base-uri 'self'",
    "form-action 'self'",
