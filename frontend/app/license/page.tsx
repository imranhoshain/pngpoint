                ...
                <div className="max-w-screen-lg container mx-auto px-4 lg:px-6 w-full">
                    <div className="bg-white shadow-sm rounded-2xl p-6 lg:p-10">
                        <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">
                            License & Usage Policy - PNGPoint.com
                        </h1>
                        <p className="text-gray-700 mb-6">
                            Welcome to <span className="font-semibold">PNGPoint.com</span>,
                        ...
                        <div className="mb-6">
                            ...
                            <ul className="list-disc list-inside text-gray-700 space-y-2">
                                <li>
                                    ...
                                    images on pngpoint.com are available for free download.
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    pngpoint.com is always appreciated to support our community.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <ul className="list-disc list-inside text-gray-700 space-y-2">
                                ...
                                <li>
                                    ...
                                    Do not claim images from pngpoint.com as your own original
                                    work.
                                </li>
                                <li>
                        ...
                        <div className="mb-6">
                            ...
                            <p className="text-gray-700">
                                All PNGs on pngpoint.com are provided under a free-to-use
                        ...
                        <div className="mb-6">
                            ...
                            <p className="text-gray-700">
                                ...
                                pngpoint.com does not guarantee absolute exclusivity of rights.
                        ...
                        <div>
                            ...
                            <p className="text-gray-700">
                                ...
                                pngpoint.com with your friends, linking to us from your blog, or
