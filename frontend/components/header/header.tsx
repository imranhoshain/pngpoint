    ...
    const faqSchema = {
        ...
        "@graph": [
            ...
            },
            {
                ...
                "url": "https://pngpoint.com/",
                "name": "Pngpoint",
                "publisher": { "@id": "https://pngpoint.com/#organization" },
                "potentialAction": {
                    "@type": "SearchAction",
            ...
            },
            {
                ...
                "description":
                    "Download high-quality, royalty-free PNG images with transparent backgrounds, perfect for web design, branding, digital content creation, and commercial projects.",
                "isPartOf": { "@id": "https://pngpoint.com/#website" },
                "breadcrumb": { "@id": "https://pngpoint.com/#breadcrumb" },
            },
            {
                "@type": "BreadcrumbList",
                "@id": "https://pngpoint.com/#breadcrumb",
                "itemListElement": [
                    { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://pngpoint.com/" },
                ],
            },
            {
                "@type": "FAQPage",
            ...
            },
            {
                ...
                "description":
                    "A curated library of transparent PNG images for design, web, print, and commercial projects.",
                "publisher": { "@id": "https://pngpoint.com/#organization" },
        ...
        <header className="relative top-0 left-0 right-0 pt-2.5 md:pt-5 pb-1.5 w-full bg-[#0077a2] text-white">
            <div className="max-w-screen-2xl container mx-auto px-2.5 lg:px-5 w-full">
                <div className="flex flex-col flex-wrap justify-center items-center w-full">
                    ...
                    />
                    <Link className="block w-fit" href={"/"} onClick={handleLogo}>
                        {/*
                         * FIX LCP: The logo is the first visible element painted on every page.
                         * - fetchPriority="high" → browser fetches it before all other resources
                         * - loading="eager"      → never lazy-load above-fold elements
                         * - explicit width/height → browser reserves exact space (no CLS)
                         *
                         * FIX CLS: Without explicit width/height the browser doesn't know the
                         * logo dimensions until the image loads, so it renders the header at
                         * a smaller height then snaps to the correct height = CLS spike.
                         *
                         * The inline style min-h matches the img height so the header
                         * never collapses while the image is in-flight.
                         */}
                        <div
                        ...
                        >
                            <img
                                ...
                                alt="PNGPoint – Free PNG Images with Transparent Background"
                                width={224}
                                height={56}
                                fetchPriority="high"
                                loading="eager"
