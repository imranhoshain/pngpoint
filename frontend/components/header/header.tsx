            ...
            <div className="max-w-screen-2xl container mx-auto px-2.5 lg:px-5 w-full">
                <div className="flex flex-col flex-wrap justify-center items-center w-full">
                    ...
                    <Link className="block w-fit" href={"/"}>
                         ...
                         * Without these the browser allocates 0×0 space for the
                         * image, then reflows the entire header once dimensions
                         * are known from the HTTP response headers. This is a
                         * primary CLS contributor on both mobile and desktop.
                         *
                         * Values match the rendered CSS sizes:
                         *   mobile  → w-40  = 160px
                         *   desktop → w-56  = 224px  ← use the largest as the intrinsic size
                         * The aspect ratio of the logo determines height.
                         * Adjust height (60) to match your actual logo aspect ratio.
                         *
                         * FIX LCP: fetchPriority="high" tells the browser this is
                         * an above-the-fold, render-critical image. Combined with
                         * the fact that it sits in the very first painted element
                         * (the header), this removes it from the LCP critical path.
                         */}
                        <img
