...
export default function Footer() {
    ...
    return (
        <footer className="relative top-0 left-0 right-0 py-10 lg:pt-16 pb-10 w-full text-white bg-[#00bcd4] flex flex-col items-center">
            <div className="max-w-screen-2xl container mx-auto px-2.5 lg:px-5 w-full">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 w-full max-w-5xl mx-auto">
                    <div className="flex flex-col flex-wrap gap-y-4 md:gap-y-2 w-full items-center text-center">
                        <FooterLogo />
                        <p className="text-xs xl:text-sm font-medium uppercase">free download transparent<br />png files no copyright</p>
                        <div className="flex flex-row flex-wrap items-center justify-center gap-x-3.5 md:gap-x-8 mt-2.5">
                            <Link href={"https://x.com/pngbay"} target="_blank">
                                <FaXTwitter className="text-xl xl:text-[22px]" />
                            </Link>
                            <Link href={"https://www.facebook.com/pngbay"} target="_blank">
                                <FaFacebook className="text-xl xl:text-[22px]" />
                            </Link>
                            <Link href={"https://www.pinterest.com/pngbay"} target="_blank">
                                <FaPinterest className="text-xl xl:text-[22px]" />
                            </Link>
                            <Link href={"https://www.instagram.com/pngba_y"} target="_blank">
                    ...
                    <div className="flex flex-col flex-wrap w-full items-center text-center">
                        <h4 className="text-base lg:text-lg xl:text-xl font-semibold uppercase">Company</h4>
                        <ul className="flex flex-col flex-wrap gap-y-2.5 md:gap-y-3 mt-2.5 md:mt-5">
                            ...
                            <li className="list-none">
                                <Link className="block w-fit text-sm xl:text-base font-normal uppercase" href={"/dmca/"}>dmca</Link>
                            </li>
                        </ul>
                    </div>
                    <div className="flex flex-col flex-wrap w-full items-center text-center">
                        ...
                        <ul className="flex flex-col flex-wrap gap-y-2.5 md:gap-y-3 mt-2.5 md:mt-5">
                            <li className="list-none">
                                <Link className="block w-fit text-sm xl:text-base font-normal uppercase" href={"https://x.com/pngbay"} target="_blank">x</Link>
                            </li>
                            <li className="list-none">
                                <Link className="block w-fit text-sm xl:text-base font-normal uppercase" href={"https://www.pinterest.com/pngbay"} target="_blank">pinterest</Link>
                            </li>
                            <li className="list-none">
                                <Link className="block w-fit text-sm xl:text-base font-normal uppercase" href={"https://www.instagram.com/pngba_y"} target="_blank">instagram</Link>
                            </li>
                            <li className="list-none">
                                <Link className="block w-fit text-sm xl:text-base font-normal uppercase" href={"https://www.facebook.com/pngbay"} target="_blank">facebook</Link>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div className="flex flex-col flex-wrap items-center justify-center pt-5">
                <p className="text-sm md:text-base">Copyright © {currentYear} PNGBay • All rights reserved • Enjoy the rest of your {todayName}!</p>
            </div>
        </footer>
    );
}