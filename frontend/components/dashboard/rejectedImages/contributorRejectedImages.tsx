...
import { useGetUserRejectedImagesQuery } from "@/redux/features/images/rejectedApi";
...
export default function ContributorRejectedImages() {
    const [value, setValue] = useState<string>("");
    const [currentPage, setCurrentPage] = useState<number>(1);
    const { FaTags, IoMdClose } = ReactIcons;

    const { data, isLoading, isError, refetch } = useGetUserRejectedImagesQuery({
        searchTerm: value,
