...
import { useGetUserApprovedImagesQuery } from "@/redux/features/images/approvedApi";
import { ReactIcons } from "@/utils/reactIcons";
import Image from "next/image";
import { useRef, useState } from "react";
import { ImagesResponse } from "@/types/imagesResponse";
import { useDispatch } from "react-redux";
import { clearSelectedMetadata, closeSidebar, openSidebar, setSelectedMetadata, setSelectedImageIds, clearSelectedImageIds } from "@/redux/features/imageSidebar/imageSideBarSlice";
...
export default function ContributorApprovedImages() {
    ...
    const { data, isLoading, isError, refetch } = useGetUserApprovedImagesQuery({
        searchTerm: value,
