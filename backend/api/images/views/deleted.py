...
from images.services.cloudflare import (
    DELETE_ALL_IMAGE_FROM_CLOUDFLARE,
    SINGLE_IMAGE_DELETE_FROM_CLOUDFLARE,
    delete_images_from_cloudflare,
)
...
class SingleImageDeleteView(viewsets.ViewSet):
    ...
    def destroy(self, request, pk=None):
        try:
            ...
            return Response(
                {"success": True, "message": "Image deleted from DB and Cloudflare."},
