...
class ImagesAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            "Classification",
            {"fields": ("category", "sub_category", "keywords", "status")},
        ),
...
@admin.register(SubCategoryPageContent)
class SubCategoryPageContentAdmin(admin.ModelAdmin):
    list_display = ["sub_category", "meta_title", "updated_at"]
    search_fields = ["sub_category__name", "meta_title"]
